import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as a,f as l}from"./app-36705845.js";const i={},t=l(`<h2 id="title-编译器架构的王者llvm——-10-变量的存储与读取" tabindex="-1"><a class="header-anchor" href="#title-编译器架构的王者llvm——-10-变量的存储与读取" aria-hidden="true">#</a> title: 编译器架构的王者LLVM——（10）变量的存储与读取</h2><h1 id="变量的存储与读取" tabindex="-1"><a class="header-anchor" href="#变量的存储与读取" aria-hidden="true">#</a> 变量的存储与读取</h1><p>变量是一款编程语言中的核心，说编译语言是一种符号处理工具，其实是有些道理的。栈式符号表可以方便的记录编译过程中的变量和语法符号，我们上节已经了解了其中的实现方法。那么，还有没有其他的办法能够简单的实现变量的存取呢？</p><h2 id="llvm的内置符号表" tabindex="-1"><a class="header-anchor" href="#llvm的内置符号表" aria-hidden="true">#</a> LLVM的内置符号表</h2><p>其实LLVM还提供了一个内部符号表，这个和我们的符号表不一样，它的符号是以函数为界的，函数内的是局部符号，外面的是全局符号。这个符号表的作用，主要是供LLVM找到各个底层的语法元素而设计的，所以它的功能较为有限。</p><p>例如下面这段字节码：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>define void @print(i64 %k1) {
entry:
	...
}
